...
class WalkingControlNode(Node):
    def __init__(self):
        ...
        self.chan_trai_client = ActionClient(self, FollowJointTrajectory, '/chan_trai_controller/follow_joint_trajectory')
        self.chan_phai_client = ActionClient(self, FollowJointTrajectory, '/chan_phai_controller/follow_joint_trajectory')
        
        self.declare_parameter('movement_duration', 2.0)  # Thoi gian mac dinh la 2 giay ^^
