...
def generate_launch_description():
    ...
    urdf_file_name = '/home/logan/exoskeleton/src/moveit/config/tongquan_sldasm.urdf.xacro'
    srdf_file_name = '/home/logan/exoskeleton/src/moveit/config/tongquan_sldasm.srdf'
    urdf_file_name = '/home/kienpvt/exos_new_ws/src/moveit/config/tongquan_sldasm.urdf.xacro'
    srdf_file_name = '/home/kienpvt/exos_new_ws/src/moveit/config/tongquan_sldasm.srdf'
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(get_package_share_directory('tongquan_sldasm'), 'launch', 'gazebo.launch.py')
            ),
            launch_arguments={
                'paused': paused,
                'gui': use_gui,
